...
final class SubscriptionDeletedTest extends TestCase
{
    ...
    {
        $this->assertTrue(is_supported('\mod_forum\event\subscription_deleted'));
    }

    public function testTranslatorShouldImplementAbstractMethods()
    {
        $event = Event::where('eventname', '\mod_forum\event\subscription_deleted')->first();
    ...
    public function testCanGetCompiler($interProd)
    {
        ...
        $this->assertEquals('App\Profiles\SubscriptionDeleted', get_class($product));
