...
final class DashboardViewedTest extends TestCase
{
    ...
    {
        $this->assertTrue(is_supported('\core\event\dashboard_viewed'));
    }

    public function testTranslatorShouldImplementAbstractMethods()
    {
        $event = Event::where('eventname', '\core\event\dashboard_viewed')->first();
    ...
    public function testCanGetCompiler($interProd)
    {
        ...
        $this->assertEquals('App\Profiles\DashboardViewed', get_class($product));
