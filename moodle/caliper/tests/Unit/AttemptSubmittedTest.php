...
final class AttemptSubmittedTest extends TestCase
{
    ...
    {
        $this->assertTrue(is_supported('\mod_quiz\event\attempt_submitted'));
    }

    public function testTranslatorShouldImplementAbstractMethods()
    {
        $event = Event::where('eventname', '\mod_quiz\event\attempt_submitted')->first();
    ...
    public function testCanGetCompiler($interProd)
    {
        ...
        $this->assertEquals('App\Profiles\AttemptSubmitted', get_class($product));
